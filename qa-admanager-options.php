...
class pt_qa_simple_admanager {
	...
	function admin_form(&$qa_content)
	{
		...
		$fields[] = array(
			...
			'label' => 'Paste HTML Ad1 Code in this box(try 728x90 banner ad).',
			'type' => 'textarea',
			'value' => qa_opt('pt_q2a_ad_after_question_codebox_0'),
			'tags' => 'NAME="pt_q2a_ad_after_question_code_field_0"',
            'rows' => 2,
		);

		$fields[] = array(
			'id' => 'pt_q2a_ad_after_question_code_display',
			'label' => 'Paste HTML Ad2 Code in this box(try 728x90 banner ad)',
			'type' => 'textarea',
			'value' => qa_opt('pt_q2a_ad_after_question_codebox_1'),
			'tags' => 'NAME="pt_q2a_ad_after_question_code_field_1"',
            'rows' => 2,
		);

		$fields[] = array(
			'id' => 'pt_q2a_ad_after_question_code_display',
			'label' => 'Paste HTML Ad3 Code in this box(try 728x90 banner ad)',
			'type' => 'textarea',
			'value' => qa_opt('pt_q2a_ad_after_question_codebox_2'),
			'tags' => 'NAME="pt_q2a_ad_after_question_code_field_2"',
            'rows' => 2,
		);

		$fields[] = array(
			'id' => 'pt_q2a_ad_after_question_code_display',
			'label' => 'Paste HTML Ad4 Code in this box(try 728x90 banner ad)',
			'type' => 'textarea',
			'value' => qa_opt('pt_q2a_ad_after_question_codebox_3'),
